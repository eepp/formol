...
[.lead]
_**Formol**_ is a Python package which helps format a cheated version
of
...
This package offers the simple `format()` function as well as the
...
[NOTE]
====
Formol has a single module file, `formol.py`, which you can copy as is
